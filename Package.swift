...
let engine: Target = releasing
    ? .binaryTarget(
        ...
        url: "https://github.com/NoMercy-Entertainment/nomercy-player-core-kmp/releases/download/v0.2.2/NoMercyPlayerCore.xcframework.zip",
        ...
        checksum: "3a9a24c3dd9d7ab486f5cc0426a3429a0a3bcf2d89fc68b3cd5ac9493818567a"
    )
    : .binaryTarget(
        name: "NoMercyPlayerCore",
